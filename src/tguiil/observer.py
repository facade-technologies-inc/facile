...
class Observer(QThread):
    ...
    def __init__(self, processID: int, backend: str = "uia") -> 'Observer':
        ...
        self._superTokens = []  # stores list of all SuperTokens
    ...
    def matchToSuperToken(self, token, parentSuperToken):
        ...
        for superToken in self._superTokens:
        ...
        if selectedSuperToken == None and bestMatch != 1:
            ...
            self._superTokens.append(newSuperToken)
