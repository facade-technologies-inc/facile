...
#
# Created: Sat Jan 25 13:49:31 2020
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionShow_Behaviors.setChecked(True)
        ...
        self.actionShow_Token_Tags = QtWidgets.QAction(MainWindow)
        self.actionShow_Token_Tags.setCheckable(True)
        self.actionShow_Token_Tags.setObjectName("actionShow_Token_Tags")
        ...
        self.menuView.addAction(self.actionShow_Behaviors)
        self.menuView.addAction(self.actionShow_Token_Tags)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionShow_Behaviors.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Show Visibility Behaviors in the TGUIM View", None, -1))
        self.actionShow_Behaviors.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+B", None, -1))
        ...
        self.actionShow_Token_Tags.setText(QtWidgets.QApplication.translate("MainWindow", "Show Token Tags", None, -1))
        self.actionShow_Token_Tags.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Show Token Tags in the TGUIM View", None, -1))
        self.actionShow_Token_Tags.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+T", None, -1))
