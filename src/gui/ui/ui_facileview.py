...
#
# Created: Fri Jan 31 10:07:32 2020
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/resources/icons/icons8-show-property-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShow_Behaviors.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/resources/icons/icons8-database-view-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDetailed_View.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/resources/icons/icons8-ophthalmology-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAutoExplore.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/resources/icons/icons8-search-property-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionManualExplore.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/resources/icons/icons8-add-property-64.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_Behavior.setIcon(icon5)
        self.actionAdd_Behavior.setObjectName("actionAdd_Behavior")
        self.actionStart_App = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/resources/icons/start_app.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStart_App.setIcon(icon6)
        self.actionStart_App.setObjectName("actionStart_App")
        self.actionStop_App = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/resources/icons/stop_app.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionStop_App.setIcon(icon7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.modulesView.headerItem().setText(1, QtWidgets.QApplication.translate("MainWindow", "Description", None, -1))
        ...
        self.actionFrom_Existing_Project.setText(QtWidgets.QApplication.translate("MainWindow", "From Existing Project", None, -1))
        ...
        self.actionTarget_GUI_Model.setText(QtWidgets.QApplication.translate("MainWindow", "Target GUI Model", None, -1))
        ...
        self.actionAdd_Behavior.setText(QtWidgets.QApplication.translate("MainWindow", "Add Behavior", None, -1))
        self.actionAdd_Behavior.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Add a visibility behavior to the target GUI model", None, -1))
        self.actionStart_App.setText(QtWidgets.QApplication.translate("MainWindow", "Start App", None, -1))
        self.actionStart_App.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Start running this project\'s target application", None, -1))
        self.actionStop_App.setText(QtWidgets.QApplication.translate("MainWindow", "Stop App", None, -1))
        self.actionStop_App.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Stop running this project\'s target application", None, -1))
